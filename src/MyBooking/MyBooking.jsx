      ...
      {bookedEvents.length === 0 ? (
        ...
        <div className="grid grid-cols-3 gap-8 pt-8">
          {bookedEvents.map((event) => (
            <div key={event.id} className="w-96 rounded  bg-base-100 shadow-xl">
              <figure>
                <img src={event.event_image} alt="Shoes" className="rounded" />
              </figure>
              <div className="card-body">
                ...
                <p className=" text-xl">
                  Thank You sir,for book this event.we will contact you as soon
                  as possible.
                </p>
              </div>
            </div>
